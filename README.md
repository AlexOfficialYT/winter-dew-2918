...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/winter-dew-2918)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/winter-dew-2918
```

A live public deployment of this template is available at [https://winter-dew-2918.templates.workers.dev](https://winter-dew-2918.templates.workers.dev)
